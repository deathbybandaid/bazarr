...
def test_supported_languages():
    assert set(supported_languages) == set(
        [
            ("zho", None, None),
            ("eng", None, None),
            ("zho", None, "Hans"),
...
def test_language_contains():
    ...
    assert language_contains(
        Language("zho", None, "Hant"), Language("zho", None, "Hant")
    )
    assert language_contains(
        Language("zho", None, "Hans"), Language("zho", None, "Hans")
    )
...
def test_search_language_in_list():
    ...
    assert search_language_in_list(
        Language("zho", None, "Hant"), [Language("zho")]
    )
    assert search_language_in_list(
        Language("zho", None, "Hans"), [Language("zho")]
    )
    assert search_language_in_list(
        Language("zho", None, "Hant"), [Language("eng"), Language("zho")]
    )
    assert not search_language_in_list(
        Language("zho", None, "Hans"), [Language("zho", None, "Hant")]
    )
    assert search_language_in_list(
